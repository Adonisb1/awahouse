...
function EscrowInitiateForm() {
  ...
  const platformFeeKobo = Math.floor(property.priceYearlyKobo * 0.015);
  const totalKobo = property.priceYearlyKobo; // Fee usually deducted from landlord or added? Specs say "Fee from landlord payout" but also shows "You Pay Full Amount"
    ...
    <div className="flex flex-col min-h-screen bg-sand pb-12">
      ...
      <div className="flex-1 px-4 py-6 overflow-y-auto">
        ...
        <div className="bg-white rounded-card p-4 border border-outline-variant flex gap-4 mb-6 shadow-sm">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex justify-between items-center">
              <KoboDisplay kobo={property.priceYearlyKobo} period="yearly" size="sm" />
        ...
        <div className="bg-sand-warm rounded-[14px] p-5 mb-8 border border-outline-variant/50">
          <div className="space-y-3">
            <div className="flex justify-between text-sm">
              ...
              <KoboDisplay kobo={property.priceYearlyKobo} color="charcoal" size="sm" />
            </div>
            <div className="flex justify-between text-sm">
            ...
            <div className="flex justify-between items-end">
              ...
              <KoboDisplay kobo={totalKobo} size="lg" color="terra" />
            </div>
            ...
            >
              <div className="flex items-baseline gap-1 mb-1">
                <span className="font-mono text-lg font-bold text-terra-dark">
                  ≈ ₦{Math.floor(property.priceYearlyKobo / 1200).toLocaleString()}
                </span>
        ...
        <Button
          ...
          size="lg"
          fullWidth
          disabled={!agreed || !handoverDate}
          onClick={() => router.push('/escrow/escrow-001')}
