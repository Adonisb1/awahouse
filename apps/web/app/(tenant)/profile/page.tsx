          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <section className="bg-white rounded-card p-8 border border-outline-variant/30 shadow-sm space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-1 p-3 bg-gray-50 rounded-lg">
                    <span className="font-mono text-[9px] uppercase text-muted tracking-wider">Total Listings</span>
                    <span className="font-bold text-charcoal">0</span>
                  </div>
                </div>
              </section>
            ...
            <section className="bg-white rounded-card p-8 border border-outline-variant/30 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-4 rounded-xl bg-success-bg border border-success/10 flex items-start gap-4">
                  <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-success shadow-sm">
                    <ShieldCheck size={16} />
                  </div>
                  <div>
                    <p className="font-bold text-sm text-success">Identity (NIN)</p>
                    <p className="text-[11px] text-success/70 mt-0.5">{isNinVerified ? 'Successfully verified' : 'Pending verification'}</p>
                  </div>
                </div>
